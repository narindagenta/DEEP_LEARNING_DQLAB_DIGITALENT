# -*- coding: utf-8 -*-
"""date_standardization.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1xDevfwMR2ZkCu_snN4maAUUwhMd9rKrz
"""
...
if __name__ == "__main__":
    print("=== Standarisasi Format Tanggal Transaksi DQMart ===")
    # Hapus baris files.upload() jika ingin menggunakan path langsung
    # from google.colab import files
    # file_Excel = files.upload()

    # Ubah ini dengan path file input Anda
    input_xlsx_path = "penjualan_dqmart_01-beta.xlsx" # Ganti dengan nama file input Anda
    print(f"File yang akan diproses: {input_xlsx_path} \n")

    # Ubah ini dengan path file output yang Anda inginkan
    output_xlsx_path = "hasil_standarisasi.xlsx" # Ganti dengan nama file output yang Anda inginkan

    normalize_tanggal_transaksi(input_xlsx_path, output_xlsx_path)
    files.download(output_xlsx_path)
    print("Proses selesai. File hasil_standarisasi.xlsx siap diunduh.")

df_output = pd.read_excel(output_xlsx_path)
